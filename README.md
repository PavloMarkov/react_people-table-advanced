...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://PavloMarkov.github.io/react_people-table-advanced/) and add it to the PR description.
